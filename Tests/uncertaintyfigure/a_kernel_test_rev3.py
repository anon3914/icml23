...
parser.add_argument('--method', type = str,default='nhanes_Age_Blood',
...
if args.plot_flag == 1:
    ...
    save_path = './Files/Results/uncertaintyplot_icml/%s/%s/%s/%s/%s.jpg' % (args.method, 'plotfeat'+ str(plotfeat), 'gpec'+str(args.use_gpec), 'labelnoise'+str(args.use_labelnoise), filename)
    ...
    if args.plot_explanations == 1:
        ...
        save_path = './Files/Results/uncertaintyplot_icml/%s/%s/%s/explanations_%s.jpg' % (args.method, 'plotfeat'+ str(plotfeat) ,str(args.kernel_normalization), filename)
    ...
    save_path = './Files/Results/uncertaintyplot_icml/%s/%s/%s/%s/output_%s.jpg' % (args.method, 'plotfeat'+ str(plotfeat), str(args.use_gpec), str(args.use_labelnoise), str(args.method))
...
if args.save_data == 1:
    ...
    save_path = './Files/Results/uncertaintyplot_icml/saved_results_%s/%s.pkl' % (prepend, filename)
